...
export default function Introduction() {
    ...
    return <div className={classes.introDiv}>
        ...
        <h3 className={`${classes.mpa} ${classes.bio}`}>An <Tooltip title={engineer} arrow><span className={classes.tooltip}>ENGINEER</span></Tooltip>, and a full-stack developer with 3 years of experience in designing, developing, and maintaining scalable, high performance & multi-platform applications</h3>
        <ExternalRef />
        <ActionButtons />
    </div>
}
